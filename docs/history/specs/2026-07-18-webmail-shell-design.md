...
une SPA React (`src/frontend`) et une API .NET 10 (`src/scotty.microservice`) permettant de
...
- Mise à jour de `src/frontend/CLAUDE.md` et correction documentaire de
  `src/scotty.microservice/CLAUDE.md` (voir § 9)
...
`src/scotty.microservice/CLAUDE.md` documente des routes admin `/api/Admin/ownerships`
...
Spec de la tranche 2a : `docs/history/specs/2026-07-18-webmail-mail-2a-design.md`.
