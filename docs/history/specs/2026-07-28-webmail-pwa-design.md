...
`docs/schema-notes.md` sur le modèle des tables précédentes, et à
appliquer sur `scotty_webmail` et `scotty_webmail_dev`.
...
| `app.name` | 1 à 60 caractères après élagage | `Scotty mail` |
| `app.shortName` | 1 à 12 caractères après élagage | `Scotty` |
