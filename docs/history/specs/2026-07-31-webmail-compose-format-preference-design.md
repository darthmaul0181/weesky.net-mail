...
**Date** — 2026-07-31
**Scope** — `src/frontend` and `src/scotty.microservice`, one new preference.
...
(`docs/history/specs/2026-07-31-webmail-plain-text-compose-design.md`). That spec states, under
"What this is not":
