...
**Livrée (5e2)** avec l'[écart 4 du plan](#annexe--écarts-avec-la-lettre-de-cette-spec-arbitrés-à-limplémentation-5e2) : aucune table `domains` n'est consultée ;
...
**Livrée (5e2)** avec les [écarts 1 à 3 du plan](#annexe--écarts-avec-la-lettre-de-cette-spec-arbitrés-à-limplémentation-5e2) : les méthodes d'écriture du store
...
`docs/schema-notes.md`. Les révisions (`calendar_revisions`) ne changent
...
## Annexe — écarts avec la lettre de cette spec, arbitrés à l'implémentation (5e2)

Remontés ici depuis le plan d'implémentation 5e2, supprimé avec les autres plans.
