...
`urn:scotty:` a été écarté : `scotty` n'est pas un NID enregistré, et un jeton est une URI. Une URI
...
consignés dans `docs/schema-notes.md`, sur le modèle de
...
`docs/known-issues/contacts-4a-residuals.md` § « À traiter en 4c » énumère cinq points. Quatre entrent
dans cette tranche :
