...
**Livrée le 15 septembre 2026** sur la branche `caldav-delivery-replies`.
...
`docs/schema-notes.md` comme les autres tables :
...
- `src/scotty.microservice/CLAUDE.md` : la liste des contrôleurs, et § « The platform seam » la
...
Documenté dans `install/optional/delivery-replies.md`, sur le modèle des
