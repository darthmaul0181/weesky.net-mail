...
namespace weesky.Scotty.Microservice.Authentication.Dav;
...
/// </summary>
internal sealed class DavAuthenticationHandler(
    ...
    : AuthenticationHandler<DavAuthenticationOptions>(options, loggerFactory, encoder)
{
        ...
        string identifier, string fingerprint, DavIdentity identity, long? generation)
    {
        ...
        var principal = new ClaimsPrincipal(
            new ClaimsIdentity(claims, DavAuthenticationDefaults.AuthenticationScheme));
