...
/// opens a MySQL connection for each database, and <c>UseScottyLogging</c> creates
/// <c>/var/log/scotty.microservice</c>, which a CI runner may not write to. Both contexts are
