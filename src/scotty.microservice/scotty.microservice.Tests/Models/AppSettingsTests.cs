...
public sealed class AppSettingsTests
{
    ...
    {
        Assert.True(AppSettings.IsValid(AppSettings.ShortName, "  Scotty  "));
        Assert.False(AppSettings.IsValid(AppSettings.ShortName, "Scotty webmail"));
    ...
    public void Normalize_TrimsAName()
        => Assert.Equal("Scotty", AppSettings.Normalize(AppSettings.ShortName, "  Scotty  "));
