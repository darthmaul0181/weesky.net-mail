...
internal static class SecurityConfiguration
{
    ...
    public static IServiceCollection AddScottyAuthentication(this IServiceCollection services)
    {
    ...
    public static string AddCredentialKeyRing(this IServiceCollection services, IWebHostEnvironment environment)
    {
        ...
        services.AddDataProtection()
            ...
            .SetApplicationName($"scotty.microservice.{environment.EnvironmentName}");
