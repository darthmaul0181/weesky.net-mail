...
/// support (<see cref="Quota"/>, <see cref="Rules"/>). The two groups can disagree — a weesky
/// deployment whose Dovecot has no ManageSieve enabled still answers <c>rules: false</c>.
/// </summary>
