...
using weesky.Snoopy.Providers.Weesky.Controllers;
using weesky.Snoopy.Providers.Weesky.Repositories;
using Xunit;

namespace weesky.Snoopy.Providers.Weesky.Tests.Controllers;

/// <summary>
/// The two api/Account writes the weesky platform owns, and the compensating work a password
/// change owes the session it just invalidated.
/// </summary>
public sealed class AccountManagementControllerTests
{
    ...
    private AccountManagementController CreateController()
    {
        ...
        var controller = new AccountManagementController(
            _usersRepo.Object, _credentials.Object, _webmailUsers.Object, _connectedAccounts.Object,
            _sessions.Object, _tokens.Object,
