...
using weesky.Scotty.Providers.Weesky.Authorization;
using weesky.Scotty.Providers.Weesky.Data;
using weesky.Scotty.Providers.Weesky.HealthChecks;
using weesky.Scotty.Providers.Weesky.Models;
using weesky.Scotty.Providers.Weesky.Platform;
using weesky.Scotty.Providers.Weesky.Repositories;
using weesky.Scotty.Providers.Weesky.Services;

namespace weesky.Scotty.Providers.Weesky;
...
public static class WeeskyPlatform
{
    ...
    public static IServiceCollection AddWeeskyPlatform(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var documentation = Path.Combine(AppContext.BaseDirectory, "scotty.providers.weesky.xml");
